...
Examples:
- Displays all available local git branches
  
      git branch 

 
- Displays all git branches
 
      git branch  -a

 
- Displays remote  git branches
  
      git branch -r

  
- Displays local git branches
...
- Displays the merged branches 

        git branch --merged     

- Displays the no-merged branches 
